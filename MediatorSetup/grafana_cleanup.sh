...
rm -rf /etc/grafana/provisioning/datasources/dac* /etc/grafana/provisioning/dashboards/dac* /var/lib/grafana/dashboards/dac* /etc/grafana/dashboards/dac*
echo "delete from dashboard where title like 'NDAC%';" | sqlite3 /var/lib/grafana/grafana.db
echo "delete from dashboard where title like 'Nokia DAC%';" | sqlite3 /var/lib/grafana/grafana.db
